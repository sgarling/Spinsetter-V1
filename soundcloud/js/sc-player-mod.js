...
(function($) {
    ...
    var html5Driver = function() {
      var player = new Audio(),
          onTimeUpdate = function(event){
            ...
            if (obj.currentTime === obj.duration) { $('a.sc-next').click(); }//callbacks.onEnd(); }
          },
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player
          .find('.sc-controls')
            .append('<a href="#next" class="sc-next">Next</a> <a href="#prev" class="sc-prev">Prev</a> <a href="#play" class="sc-play">Play</a> <a href="#pause" class="sc-pause hidden">Pause</a>')
          .end()
  ...
  $.scPlayer.defaults = $.fn.scPlayer.defaults = {
    ...
    apiKey: '78bfc6a742a617082972ddc5ef20df2a'
  };
  ...
  $('a.sc-next').live('click', function(event) {
    var nextTrack = $('li.active').next();
    if (!nextTrack.length) {
      nextTrack = $('ol.sc-trackslist').children().filter(':first');
    }
    nextTrack.click();
  });
  ...
  $('a.sc-prev').live('click', function(event) {
    var nextTrack = $('li.active').prev();
    if (!nextTrack.length) {
      nextTrack = $('ol.sc-trackslist').children().filter(':last');
    }
    nextTrack.click();
  });
  ...
  $(document).keydown(function(e) {
    ...
    if (e.keyCode === 40) {
      if (soundVolume > 5) {
        var newVolume = soundVolume - 5;
        onVolume(newVolume);
        $('span.sc-volume-status').css({width: newVolume + '%'});
      }
    }
    if (e.keyCode === 38) {
      var newVolume = soundVolume + 5;
